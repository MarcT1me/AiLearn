...
class AIModel:
    def __init__(self, size: int | Iterable = 28*28, *args, **kwargs):
        ...
        # вход - категории
        self.model.add(keras.layers.Dense(10, activation='relu'))  # 784
        ...
        # выход ЧБ пиксели
        self.model.add(keras.layers.Dense(size, activation='sigmoid'))  # 10
    ...
    def learn(self, *, path: str | Path) -> list:
        ...
        # преобразование
        print('compile data')
        data_array = keras.utils.to_categorical(data, num_classes=10)
...
def main() -> None:
    ...
    name = 'MNIST_generate_model_1.h5'
